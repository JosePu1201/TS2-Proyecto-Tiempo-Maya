  ...
  <div class="container" style="padding-left: 200px;">
    <nav class="navbar navbar-expand-lg" id="nav-menu-container">
      <div class="container-fluid bg-dark text-white">
        <a id="title" class="navbar-brand" href="index.php" style="color: white;font-size: 24px;"><img src="./imgs/icon_tiempo_maya.jpg" alt="" width="70" height="70"><strong> TIEMPO</strong> MAYA</a>
